...
class Car:
    def __init__(self, x, y):
        ...
        self.original_image = scale_image(pygame.image.load("imgs/mario_top.png"), 0.55)
...
class RacingEnv:
    ...
    def __init__(self):
        ...
        self.height = 900
        self.history = []
        self.back_image = scale_image(pygame.image.load("imgs/track.png"), 0.9)
        self.finish = pygame.image.load("imgs/finish.png")
        self.finish_pos = (130, 250)
        self.screen = pygame.display.set_mode((self.back_image.get_width(), self.back_image.get_height()))
        pygame.display.set_caption("MARIOKART AGENT")
